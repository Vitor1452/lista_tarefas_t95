...
<head>
    ...
    <meta name="keywords" content=" Lista de tarefas, tarefas, php, html, css, js" >
...
<body>
    ...
    <main class="container-fluid d-flex flex-column " >
        ...
        ?>
            ...
            <ul class="col-md-6 m-md-5 p-0 p-md-2 " >

                <li class="h4 p-3 p-md-2 d-flex flex-column flex-md-row justify-content-between align-items-center relativo ">

                    Tarefa 01
                    
                <div class="d-flex flex-row lado" >    
